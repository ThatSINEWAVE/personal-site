...
"Want to kill the Spy Pet bot on your favorite Discord server? They let their account ID's leak from their official API... Now we have a tool to get the bot ID's anyway.
1. Turn on Discord developer tools
2. Right click on your server icon and Copy Server ID.
3. Change this URL to include your Server ID: https://kickthespy.pet/getBot?id=ID
4. Ban the bot account detected for your server."
...
[![](https://sinewave.vercel.app/Spy.pet-3)](https://sinewave.vercel.app/blog/spypet)
...
[![](https://sinewave.vercel.app/spyDOTpet-2)](https://sinewave.vercel.app/blog/spypet)
...
Despite mounting evidence, the owner continued making denials and excuses in the face of their illegal operation being shut down.

[![](https://sinewave.vercel.app/spyDOTpet-1)](https://sinewave.vercel.app/blog/spypet)

However, the site began going down globally as the confirmed actions took effect.
...
By April 28th, they had set up a potential new domain at spying.pet and stated plans to re-infiltrate servers:
...
[![](https://sinewave.vercel.app/Spy.pet-1)](https://sinewave.vercel.app/blog/spypet)
