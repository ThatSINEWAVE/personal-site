...
**The Shadow Team** had created kickthespy.pet, explaining it _"tries to find the discord scraper spy.pet's bot accounts in your server...via an API vulnerability...where we got all of their accounts in all servers."_ However, they warned this was just a "snapshot" as spy.pet could create new bots.
