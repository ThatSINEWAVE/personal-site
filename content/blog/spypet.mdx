...
Spy.pet is a website that **scrapes data from Discord**, allowing anyone to pay a as __low as 5 dollars__ to look up a user's profile, see what servers they are in, view their messages, and more. It boasts over **300 million Discord users** in its database, which is still growing.
